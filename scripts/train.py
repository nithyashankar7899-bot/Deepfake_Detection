...
def main(args):
    ...
    best_val_acc = -1.0  # -1 so even a 0.0% first epoch gets saved as a starting checkpoint
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # always save the latest epoch so you have something to run predict.py against
        last_ckpt_path = os.path.join(args.out_dir, "last_model.pth")
